...
<div class="pd-20" >
    <form action="" method="post" class="form form-horizontal" id="form-doc-add">
        <div class="row cl">
            ...
            <div class="formControls col-10" style="text-align: center; margin:0 auto; font-weight: bold; ">
                <label  id="title" name="title" style="font-size:30px;">${doc.title}</label>
            </div>
        </div>
        ...
        <div class="row cl"  style="text-align: center; margin:0 auto; ">
            ...
            <div class="formControls col-10">
                <label id="type" name="type">${doc.type}</label>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10" >
                <textarea id="content" name="content"  cols="" rows="" style="height:300px" class="textarea" dragonfly="true">${doc.content}</textarea>
