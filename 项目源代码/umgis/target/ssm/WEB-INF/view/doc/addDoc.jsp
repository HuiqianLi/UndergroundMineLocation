    ...
    <form action="" method="post" class="form form-horizontal" id="form-doc-add">
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="title" datatype="*" nullmsg="标题不能为空">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="type" name="type" datatype="*" nullmsg="类型不能为空">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <textarea id="content" name="content" cols="" rows="" style="height:250px" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-2000" dragonfly="true" nullmsg="内容不能为空！" onKeyUp="textarealength(this,2000)"></textarea>
