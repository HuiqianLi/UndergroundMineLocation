    ...
    <form action="" method="post" class="form form-horizontal" id="form-doc-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="position1" name="position1" datatype="*" nullmsg="位置1不能为空">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="position2" name="position2" datatype="*" nullmsg="位置2不能为空">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="position3" name="position3" datatype="*" nullmsg="位置2不能为空">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="area" name="area" datatype= "*">
            </div>
        </div>
