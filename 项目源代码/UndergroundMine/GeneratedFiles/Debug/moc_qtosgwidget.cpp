...
QT_MOC_LITERAL(1, 12, 16), // "trackballRotated"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "osg::Quat"
QT_MOC_LITERAL(4, 40, 1), // "q"
QT_MOC_LITERAL(5, 42, 15) // "rotateTrackball"

    },
    "QtOSGWidget\0trackballRotated\0\0osg::Quat\0"
    "q\0rotateTrackball"
};
...
void QtOSGWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->trackballRotated((*reinterpret_cast< osg::Quat(*)>(_a[1]))); break;
        case 1: _t->rotateTrackball((*reinterpret_cast< osg::Quat(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (QtOSGWidget::*_t)(osg::Quat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtOSGWidget::trackballRotated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void QtOSGWidget::trackballRotated(osg::Quat _t1)
{
